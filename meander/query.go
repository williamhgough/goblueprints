...
// APIKey is to hold the google places key
var APIKey string

// Place represents a place result from Google API
type Place struct {
...
// Public defines how we want places to
